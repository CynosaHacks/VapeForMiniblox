...
(function() {
	...
	addReplacement('VERSION$1," | ",', `"${vapeName} [Central+ Injected] VID: [13123-15032-42714]"," | ",`);
	...
	game$1.chat.addChat({text: "Login Bypassed from localStorage.token"});
	...
	addReplacement('document.addEventListener("contextmenu",j=>j.preventDefault());', `
		...
		(function() {
			...
			chatdisablermsg = chatdisabler.addoption("Message", String, "https://github.com/CynosaHacks/VapeForMiniblox/  for miniblox cheats!");
